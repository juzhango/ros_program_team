...
#include "../../../../src/syscore_rqt_regions/include/syscore_rqt_regions/pointwidget.h"
...
static const char qt_meta_stringdata_PointWidget[] = {
    "PointWidget\0"
};
...
const QMetaObjectExtraData PointWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject PointWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_PointWidget,
      qt_meta_data_PointWidget, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &PointWidget::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PointWidget))
