...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'syscore_rqt_regions' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/teabot/my_workSpace/a/ros_program_team/catkin_rqt3.0/install/${idir}'.  Ask the maintainer 'arong <anqingrong@163.com>' to fix it.")
    endif()
