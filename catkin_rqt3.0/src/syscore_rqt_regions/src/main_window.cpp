...
#include "../include/syscore_rqt_regions/main_window.hpp"

#include <QtGui>
#include <QMessageBox>
#include <iostream>
#include "../include/syscore_rqt_regions/output_format_yaml.h"
...
void MainWindow::ReadSettings() {
    QSettings settings("Qt-Ros Package", "syscore_rqt_regions");
...
/**
  ...
  * @retval None
  */
void syscore_rqt_regions::MainWindow::slot_update_laserScan(QPolygon polygon)
{
...
void syscore_rqt_regions::MainWindow::disableRepalceBtn()
{
...
void syscore_rqt_regions::MainWindow::enableRepalceBtn()
{
...
// inner
void syscore_rqt_regions::MainWindow::slot_btn_set_point_inner_pressed(){
  enableSetPolytonBtn();
...
void syscore_rqt_regions::MainWindow::slot_btn_replace_point_inner_pressed()
{
  disableRepalceBtn();
...
void syscore_rqt_regions::MainWindow::slot_btn_clean_point_inner_pressed()
{
...
// mid
void syscore_rqt_regions::MainWindow::slot_btn_set_point_mid_pressed()
{
  enableSetPolytonBtn();
...
void syscore_rqt_regions::MainWindow::slot_btn_replace_point_mid_pressed(){
  disableRepalceBtn();
  QPoint point = pointWidget->getCurrentClickPoint();
  QPoint point_qt = pointWidget->getCurrentClickPoint_qt();
...
void syscore_rqt_regions::MainWindow::slot_btn_clean_point_mid_pressed()
{
...
// out
void syscore_rqt_regions::MainWindow::slot_btn_set_point_out_pressed(){
  enableSetPolytonBtn();
...
void syscore_rqt_regions::MainWindow::slot_btn_replace_point_out_pressed(){
  disableRepalceBtn();
  QPoint point = pointWidget->getCurrentClickPoint();
  QPoint point_qt = pointWidget->getCurrentClickPoint_qt();
...
void syscore_rqt_regions::MainWindow::slot_btn_clean_point_out_pressed(){
...
void syscore_rqt_regions::MainWindow::slot_btn_close_polygon_pressed()
{
  enablePointBtn();
  innerPointTable->cleanPolygon();
  midPointTable->cleanPolygon();
...
// inner
void syscore_rqt_regions::MainWindow::slot_btn_set_polygon_inner_pressed(){
...
void syscore_rqt_regions::MainWindow::slot_btn_close_polygon_inner_pressed(){
  enablePointBtn();
  ui.btn_set_polygon_inner->setEnabled(true);

}
void syscore_rqt_regions::MainWindow::slot_btn_clean_polygon_inner_pressed(){
  pointWidget->resetMarkPoint();
  pointWidget->resetMarkPolygon();
...
// mid
void syscore_rqt_regions::MainWindow::slot_btn_set_polygon_mid_pressed(){
...
void syscore_rqt_regions::MainWindow::slot_btn_close_polygon_mid_pressed(){
  enablePointBtn();
  ui.btn_set_polygon_mid->setEnabled(true);
  midPointTable->cleanPolygon();
  pointWidget->resetMarkPolygon();
}
void syscore_rqt_regions::MainWindow::slot_btn_clean_polygon_mid_pressed(){
  pointWidget->resetMarkPoint();
  pointWidget->resetMarkPolygon();
...
// out
void syscore_rqt_regions::MainWindow::slot_btn_set_polygon_out_pressed(){
...
void syscore_rqt_regions::MainWindow::slot_btn_close_polygon_out_pressed(){
  enablePointBtn();
  ui.btn_set_polygon_out->setEnabled(true);
  outPointTable->cleanPolygon();
  pointWidget->resetMarkPolygon();
}
void syscore_rqt_regions::MainWindow::slot_btn_clean_polygon_out_pressed(){
  pointWidget->resetMarkPoint();
  pointWidget->resetMarkPolygon();
...
// scenes
void syscore_rqt_regions::MainWindow::slot_btn_set_scene_pressed()
{
  /* 0.judge empty
   * 1.generate scene
...
void syscore_rqt_regions::MainWindow::slot_btn_replace_scene_pressed()
{
  /* 0.judge empty
   * 1.replace scene
   * 2.update scene table
...
void syscore_rqt_regions::MainWindow::slot_btn_clean_scene_pressed()
{
  pointWidget->resetMarkPoint();
  pointWidget->resetMarkPolygon();
...
/**
  ...
  * @retval None
  */
void syscore_rqt_regions::MainWindow::clean_point_polygon_painter()
{
  innerPointTable->cleanPolygon();
  midPointTable->cleanPolygon();
  outPointTable->cleanPolygon();
...
/**
  ...
  * @retval None
  */
void syscore_rqt_regions::MainWindow::slot_btn_scene_output_pressed()
{
...
void syscore_rqt_regions::MainWindow::slot_btn_scene_input_pressed()
{
  /*
   * 1.clean scene
...
void syscore_rqt_regions::MainWindow::slot_btn_set_topic_pressed()
{
...
void syscore_rqt_regions::MainWindow::slot_btn_reset_topic_pressed()
{
  /*
   * 1.disable btn_reset
   * 2.enable btn_set
...
void syscore_rqt_regions::MainWindow::slot_btn_set_paramName_pressed()
{
...
void syscore_rqt_regions::MainWindow::slot_btn_reset_paramName_pressed()
{
  /*
   * 1.disable btn_reset
   * 2.enable btn_set
...
void syscore_rqt_regions::MainWindow::enableSetPolytonBtn()
{
  ui.btn_set_polygon_inner->setEnabled(true);
  ui.btn_set_polygon_mid->setEnabled(true);
  ui.btn_set_polygon_out->setEnabled(true);
...
void syscore_rqt_regions::MainWindow::disablePolygonBtn()
{
...
void syscore_rqt_regions::MainWindow::disableInnerPointBtn()
{
  ui.btn_set_point_inner->setEnabled(false);
  ui.btn_replace_point_inner->setEnabled(false);
  ui.btn_clean_point_inner->setEnabled(false);
}
void syscore_rqt_regions::MainWindow::disableMidPointBtn()
{
...
void syscore_rqt_regions::MainWindow::disableOutPointBtn()
{
  ui.btn_set_point_out->setEnabled(false);
  ui.btn_replace_point_out->setEnabled(false);
  ui.btn_clean_point_out->setEnabled(false);
}
void syscore_rqt_regions::MainWindow::disablePointBtn()
{
  disableInnerPointBtn();
  disableMidPointBtn();
  disableOutPointBtn();
}
void syscore_rqt_regions::MainWindow::enableInnerPointBtn()
{
  ui.btn_set_point_inner->setEnabled(true);
  ui.btn_replace_point_inner->setEnabled(true);
  ui.btn_clean_point_inner->setEnabled(true);
}
void syscore_rqt_regions::MainWindow::enableMidPointBtn()
{
...
void syscore_rqt_regions::MainWindow::enableOutPointBtn()
{
  ui.btn_set_point_out->setEnabled(true);
  ui.btn_replace_point_out->setEnabled(true);
  ui.btn_clean_point_out->setEnabled(true);
}
void syscore_rqt_regions::MainWindow::enablePointBtn()
{
  enableInnerPointBtn();
  enableMidPointBtn();
  enableOutPointBtn();
...
void syscore_rqt_regions::MainWindow::slot_inner_del_painter(int i)
{
...
void syscore_rqt_regions::MainWindow::slot_mid_del_painter(int i)
{
...
void syscore_rqt_regions::MainWindow::slot_out_del_painter(int i)
{
...
void syscore_rqt_regions::MainWindow::slot_clean_point_polygon_painter()
{
  clean_point_polygon_painter();
}
/**
  ...
  * @retval None
  */
void syscore_rqt_regions::MainWindow::slot_menu_edit_scene()
{
  /*
   * 1.enable scene btn
   *
...
void syscore_rqt_regions::MainWindow::slot_painter_Mark(QPoint point_qt)
{
  pointWidget->setMarkPoint(point_qt);
  pointWidget->update();
}
// right click menu insert
void syscore_rqt_regions::MainWindow::slot_inner_insert_point(int i)
{
  if(innerPolygonTable->getReadOnly() == false){
...
void syscore_rqt_regions::MainWindow::slot_mid_insert_point(int i)
{
  if(midPolygonTable->getReadOnly() == false){
...
void syscore_rqt_regions::MainWindow::slot_out_insert_point(int i)
{
  if(outPolygonTable->getReadOnly() == false){
...
/**
  ...
  * @retval None
  */
void syscore_rqt_regions::MainWindow::slot_painter_inner_MarkPolygon(QPolygon polygon, QPolygon polygon_qt)
{
  /*
   * 1.enable btn edit
...
void syscore_rqt_regions::MainWindow::slot_painter_mid_MarkPolygon(QPolygon polygon, QPolygon polygon_qt)
{
  /*
   * 1.enable btn edit
   * 2.setTablePoint base && update table
...
void syscore_rqt_regions::MainWindow::slot_painter_out_MarkPolygon(QPolygon polygon, QPolygon polygon_qt)
{
  /*
   * 1.enable btn edit
   * 2.setTablePoint base && update table
...
void syscore_rqt_regions::MainWindow::slot_edit_innerPolygon_table()
{
  /*
   * 1.btn enable
...
void syscore_rqt_regions::MainWindow::slot_edit_midPolygon_table()
{
  /*
   * 1.btn enable
   * 2.clean appoint polygon table
...
void syscore_rqt_regions::MainWindow::slot_edit_outPolygon_table()
{
  /*
   * 1.btn enable
   * 2.clean appoint polygon table
...
void syscore_rqt_regions::MainWindow::slot_request_enable_replaceBtn()
{
...
void syscore_rqt_regions::MainWindow::slot_launchUpdateTable(std::vector<QPolygon> innerVpolygon,std::vector<QPolygon> midVpolygon,std::vector<QPolygon> outVpolygon)
{
  /*
...
void syscore_rqt_regions::MainWindow::slot_update_painter()
{
  // update painter
  pointWidget->updateVectorInnerArea(innerPolygonTable->getTableVectorPolygon_qt(),innerPointTable->getTablePolygon_qt());
  pointWidget->updateVectorMidArea(midPolygonTable->getTableVectorPolygon_qt(),midPointTable->getTablePolygon_qt());
