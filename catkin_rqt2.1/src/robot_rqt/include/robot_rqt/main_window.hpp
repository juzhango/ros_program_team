/**
 * @file /include/robot_rqt/main_window.hpp
 *
 * @brief Qt based gui for robot_rqt.
 *
 * @date November 2010
 **/
#ifndef robot_rqt_MAIN_WINDOW_H
#define robot_rqt_MAIN_WINDOW_H
